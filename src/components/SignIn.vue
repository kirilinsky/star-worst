<template>
  <div>
    ...
    <form class="form login-form" @submit.prevent="setNewUser">
      ...
      <div class="login-form__buttons">
        ...
        <span class="login-form__account" @click="goToSignUp"
      ...
      tryToSignIn(userData)
        ...
        .catch((err) => {
          this.openNotification(
            ...
            "rgb(255, 71, 87)",
            "Ошибка регистрации!",
            "Ну и дела... Перепроверь все и давай снова!"
          );
        });
    },
    goToSignUp() {
